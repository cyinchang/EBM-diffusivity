...
global A B SW D0 rh c N x albo albi dfn SW_input dfn_input alb_P2 albref Tref Tref_input alb do_D_T0 do_D_T2 gamma
...
% === model equations ===
function F=dTdt(~,T)
global A B SW D0 rh c N x albo albi dfn SW_input dfn_input alb alb_P2 albref Tref Tref_input do_D_T0 do_D_T2 gamma
...
if Tref_input
  D = calc_D(D0,T,Tref,x,do_D_T0,do_D_T2,gamma);
  D = repmat(D,N+1,1);
else
